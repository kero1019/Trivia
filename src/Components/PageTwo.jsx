            ...
            <div className=" flex flex-col items-center">
                {
                    quizForm.map((data , index)=>{
                        return <Category key={index} question={data.question} options = {data.options} setQuizForm={setQuizForm} correctAnswer={data.correctAnswer} checkAnswer={checkAnswer} />
                    })
                }
